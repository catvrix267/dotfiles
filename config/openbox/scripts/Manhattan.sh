...
set_wallpaper() {
	...
	nitrogen --save --set-zoom-fill ~/Imagens/Wallpapers/ign_colorful.png
}
...
# funct STYLE FONT
change_polybar 'manhattan' 'Operator Mono Lig:size=12;3' && "$polybar_path"/launch.sh

# funct STYLE FONT BORDER BORDER-RADIUS ICON (Change colors in funct)
change_rofi 'manhattan' 'Operator Mono Lig Medium 12' '0px' '0px' 'Arc-Circle'

# funct STYLE (network manager applet)
change_nm 'manhattan'

# funct FONT SIZE (Change colors in funct)
change_terminal 'Operator Mono Lig Medium' '12'

# funct FONT (Change colors in funct)
change_xfce_terminal 'Operator Mono Lig Medium 12'

# funct SCHEME FONT
change_geany 'manhattan' 'Operator Mono Lig Medium 12'

# funct THEME ICON CURSOR FONT
change_appearance 'Manhattan' 'Arc-Circle' 'Qogirr' 'Operator Mono Lig Medium 12'

# funct THEME LAYOUT FONT SIZE (Change margin in funct)
obconfig 'Manhattan' 'CIML' 'Operator Mono Lig Medium' '12' 'menu-icons.xml' && openbox --reconfigure

# funct GEOMETRY FONT BORDER (Change colors in funct)
change_dunst '280x50-20+20' 'Operator Mono Lig Medium 12' '0'
