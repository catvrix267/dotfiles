...
# funct STYLE FONT
change_polybar 'nordic' 'Operator Mono Lig Medium:size=12;3' && "$polybar_path"/launch.sh

# funct STYLE FONT BORDER BORDER-RADIUS ICON (Change colors in funct)
change_rofi 'nordic' 'Operator Mono Lig Medium 12' '0px' '0px' 'Numix-Apps'
...
# funct SCHEME FONT
change_geany 'nordic' 'Operator Mono Lig Medium 12'
...
obconfig 'Nordic' 'LIMC' 'Operator Mono Lig Medium' '12' 'menu-icons.xml' && openbox --reconfigure

# funct GEOMETRY FONT BORDER (Change colors in funct)
change_dunst '280x50-10+48' 'Operator Mono Lig Medium 12' '0'
